...
<script type="text/javascript" src="${PageContext.request.ContextPath}/tiantian/admin/lib/layui/layui.js"
...
<body class="layui-anim layui-anim-up">
	<div class="x-nav">
		...
		<button class="layui-btn"
			onclick="x_admin_show('添加用户','${PageContext.request.ContextPath}/tiantian/DataServlet?method=printExcel',600,650)">
			<i class="layui-icon"></i>导出所有数据
		</button>
	<script>
