...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" action="${PageContext.request.ContextPath}/tiantian/OrdersServlet?method=updateOrderItem&oid=${orderItem.oders.oid }" method="post">
			<div class="layui-form-item">
				<label  class="layui-form-label"> <span
					class="x-red">*</span>订单项编号
				</label>
				<div class="layui-input-inline">
					<input type="text" id="itemid" name="itemid" required=""
						 autocomplete="off" class="layui-input" value="${orderItem.itemid }">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="pname" name="pname" required=""
						 autocomplete="off" class="layui-input" value="${orderItem.product.pname }">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="shop_price" name="shop_price" required=""
						 autocomplete="off" class="layui-input" value="${orderItem.product.shop_price }">
				</div>
			</div>
			<div class="layui-form-item">
				<label  class="layui-form-label"> <span
				...
				<div class="layui-input-inline">
					<input type="text" id="quantity" name="quantity" required=""
						 autocomplete="off" class="layui-input" value="${orderItem.quantity }">
				</div>
			</div>
			<div class="layui-form-item">
				<label  class="layui-form-label"> <span
				...
				<div class="layui-input-inline">
					<input type="text" id="total" name="total" required=""
						 autocomplete="off" class="layui-input" value="${orderItem.total }">
				</div>
			</div>
			<div class="layui-form-item">
