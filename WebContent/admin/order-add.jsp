...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" action="${PageContext.request.ContextPath}/tiantian/OrdersServlet?method=addOrders_back&oid=${orders.oid}" method="post">
			
			<div class="layui-form-item">
				<label  class="layui-form-label"> <span
					class="x-red">*</span>收货地址
				</label>
